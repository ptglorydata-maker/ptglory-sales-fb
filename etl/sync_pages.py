...
UNITS = {
    "U4": {
        ...
        "page_tabs": [
            ...
            "[P3] Ha Yeon - ครีมโสมลดฝ้า",                # active (P3, เบลล์) — เปลี่ยนชื่อ tab อีกครั้งเมื่อ (เพิ่มวงเล็บ [P3] กลับมา)
    ...
    "U9": {
        ...
        "page_tabs": [
            "[P8] Levonglow-ชาแม่แย้มดูแลโดยแพทย์แผนไทย",  # เปลี่ยนชื่อ tab เพิ่มวรรคหลัง ] (เช็คจริง 17/8/2569)
    ...
    "U12 ลาว": {
        "source_sheet_id": "1zj6ETKYJi5wh9WJPI8sf6UPJ7wwRzFo3iV4xrZnbwjw",
        # ยืนยันด้วย --discover แล้ว (22/8/2569): มี 2 tab ต่อเพจ โครงสร้างคอลัมน์เหมือนยูนิตอื่นปกติ
        # master catalog มี U12 ลาว 2 เพจพอดี (ชื่อ tab ตรงกับ catalog แค่ตัด "[P1]/[P2] " นำหน้าออก):
        "page_tabs": [
            "ເຈສັນ ເອັມ - ວິຕາມິນບຳລຸງຕໍ່ມລູກໝາກ ສົ່ງຕົງຈາກເພຈບໍລິສັດ",
            "DWAWA - Jason Mຜູ້ຊາຍສຸຂະພາບດີ ປັດສະວະຄ່ອງ",
        ],
        "tab_to_catalog": {
            "ເຈສັນ ເອັມ - ວິຕາມິນບຳລຸງຕໍ່ມລູກໝາກ ສົ່ງຕົງຈາກເພຈບໍລິສັດ": "[P1] ເຈສັນ ເອັມ - ວິຕາມິນບຳລຸງຕໍ່ມລູກໝາກ ສົ່ງຕົງຈາກເພຈບໍລິສັດ",
            "DWAWA - Jason Mຜູ້ຊາຍສຸຂະພາບດີ ປັດສະວະຄ່ອງ": "[P2] DWAWA - Jason Mຜູ້ຊາຍສຸຂະພາບດີ ປັດສະວະຄ່ອງ",
        },
    },
    "Test Menova": {
