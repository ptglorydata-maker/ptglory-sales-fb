...
ทั้ง 6 tab ต้องจับคู่ด้วยมือผ่าน `TAB_TO_CATALOG_PAGE` ในไฟล์ config แทน (fuzzy match เสี่ยง
จับคู่ผิดเพจ) ตอนนี้ยืนยันคู่ที่ตรงกันจริงของ 2 เพจ active ของ U4 ไว้แล้ว
