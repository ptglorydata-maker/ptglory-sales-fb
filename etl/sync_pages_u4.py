...
# ตำแหน่งคอลัมน์ (นับจาก 1, A=1) ต่อบล็อกเดือนในแต่ละ tab เพจ — ยังไม่ยืนยัน
# ต้องเติมค่าจริงหลังดูผล `--discover "ชื่อ tab"` (แถวหัวตาราง + ตัวอย่างแถวข้อมูล)
# key = ชื่อ tab, value = (col_sales, col_orders, col_ad_spend, col_roas)
PAGE_COLUMN_MAP = {
    # "Ha Yeon-ฮายอง ครีมโสมเกาหลี": (2, 3, ...),
}
# ====================================================
